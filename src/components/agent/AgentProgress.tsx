...
function stepIcon(status: ProgressStep['status']): React.ReactNode {
  switch (status) {
    case 'completed': 
      return (
        <span className="agent-step-icon">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--cds-support-success)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
    ...
    case 'failed':    
      return (
        <span className="agent-step-icon">
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--cds-support-error)" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" style={{ display: 'block' }}>
