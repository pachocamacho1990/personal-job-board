 ...
 * GET /api/business
 */
export const getEntities = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
 ...
 * POST /api/business
 */
export const createEntity = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
 ...
 * PUT /api/business/:id
 */
export const updateEntity = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
        const { id } = req.params;
        const { name, type, status, contact_person, email, website, location, notes } = req.body;
 ...
 */
export const deleteEntity = async (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    try {
        const { id } = req.params;
